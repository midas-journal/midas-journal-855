/*=========================================================================
  ...
  Module:    $RCSfile: itkBSplineInterpolationWeightFunctionSecondDerivative.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkBSplineInterpolationWeightFunctionSecondDerivative_h
#define __itkBSplineInterpolationWeightFunctionSecondDerivative_h
...
#include "itkBSplineSecondDerivativeKernelFunction.h"
...
/** \class BSplineInterpolationWeightFunctionSecondDerivative
 * \brief 
 *
...
>
class ITK_EXPORT BSplineInterpolationWeightFunctionSecondDerivative : 
  public FunctionBase< ContinuousIndex<TCoordRep,VSpaceDimension>, 
                       Array<double> > 
{
public:
  /** Standard class typedefs. */
  typedef BSplineInterpolationWeightFunctionSecondDerivative Self;
  ...
  itkTypeMacro(BSplineInterpolationWeightFunctionSecondDerivative, FunctionBase);
   ...
   */
  virtual void EvaluateSecondDerivative( const ContinuousIndexType & index,
...
private:
  BSplineInterpolationWeightFunctionSecondDerivative(const Self&); //purposely not implemented
  ...
  typedef BSplineSecondDerivativeKernelFunction<itkGetStaticConstMacro(SplineOrder)> KernelSecondDerivativeType;
  typename KernelSecondDerivativeType::Pointer m_KernelSecondDerivative;
...
#if ITK_TEMPLATE_TXX
# include "itkBSplineInterpolationWeightFunctionSecondDerivative.txx"
#endif
