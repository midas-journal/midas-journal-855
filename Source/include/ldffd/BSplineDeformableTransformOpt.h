...
#ifndef __itkBSplineDeformableTransformOpt_h
#define __itkBSplineDeformableTransformOpt_h
 ...
 * \brief Deformable transform using a BSpline representation with optimization
 *
...
public:
  ...
  // <ADDED>
  /* Derivatives of bspline weighting functions
   */
  typedef BSplineInterpolationWeightFunctionDerivative<ScalarType, 
    itkGetStaticConstMacro(SpaceDimension),
 ...
 //<ADDED>
  ...
  virtual bool GetClassicalJacobian
    (const InputPointType & point, ClassicalJacobianType& jacobianMatrix) const;
  //</ADDED>
...
#define ITK_TEMPLATE_BSplineDeformableTransformOpt(_, EXPORT, x, y) namespace itk { \
  _(3(class EXPORT BSplineDeformableTransformOpt< ITK_TEMPLATE_3 x >)) \
  namespace Templates { typedef BSplineDeformableTransform< ITK_TEMPLATE_3 x > \
                                                   BSplineOptDeformableTransform##y; } \
  }

#if ITK_TEMPLATE_EXPLICIT
# include "Templates/itkBSplineDeformableTransformOpt+-.h"
#endif
...
#endif /* __itkBSplineDeformableTransformOpt_h */
